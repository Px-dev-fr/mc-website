...
//AOS
if ( ! empty( $data_aos ) ) {
	$wrapper_attributes[] = 'data-aos="' . esc_attr( $data_aos ) . '"';
}
if ( ! empty( $data_aos_delay ) ) {
	$wrapper_attributes[] = 'data-aos-delay="' . esc_attr( $data_aos_delay ) . '"';
}
if ( ! empty( $data_aos_duration ) ) {
	$wrapper_attributes[] = 'data-aos-duration="' . esc_attr( $$data_aos_duration ) . '"';
}
