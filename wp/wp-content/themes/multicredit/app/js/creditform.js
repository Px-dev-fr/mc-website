...
function submitForm() {
	...
	var naissanceDate = $('#cr_f #naissance-yyyy').val() + '-' + $('#cr_f #naissance-mm').val() + '-' + $('#cr_f #naissance-dd').val()
	var dataToSubmit = $('#cr_f').serialize() + "&montant=" + getParameterByName('montant') + "&duree=" + getParameterByName('duree') + "&prestac=&naissance=" + naissanceDate + "&soumission=1&poursuites=" + poursuites;
	var xhr = new XMLHttpRequest();
	xhr.open("POST", '/wp/wp-content/themes/multicredit/formulaire-demande-credit.php', true);
	    ...
	    if (xhr.readyState == XMLHttpRequest.DONE) {
			...
			switch(document.getElementsByName("langue")[0].value) {
			  case "fr":
					...
					break;
			case "en":
					window.location.replace("https://www.multicredit.ch/en/thank-you-for-your-request/?retour="+encodeURI(xhr.responseText));
					break;
			case "de":
					window.location.replace("https://www.multicredit.ch/de/vielen-dank-fur-die-anfrage/?retour="+encodeURI(xhr.responseText));
					break;
			case "it":
					window.location.replace("https://www.multicredit.ch/it/grazie-per-la-vostra-richiesta/?retour="+encodeURI(xhr.responseText));
					break;
			case "pt-pt":
					window.location.replace("https://www.multicredit.ch/pt-pt/obrigado-pelo-seu-pedido/?retour="+encodeURI(xhr.responseText));
					break;
			case "es":
					window.location.replace("https://www.multicredit.ch/es/gracias-por-su-solicitud/?retour="+encodeURI(xhr.responseText));
					break;
			case "sq":
					window.location.replace("https://www.multicredit.ch/sq/faleminderit-per-kerkesen-tuaj/?retour="+encodeURI(xhr.responseText));
					break;
			case "tr":
					window.location.replace("https://www.multicredit.ch/tr/istegin-icin-tesekkurler/?retour="+encodeURI(xhr.responseText));
					break;
			default:
					window.location.replace("https://www.multicredit.ch/fr/merci-pour-votre-demande/?retour="+encodeURI(xhr.responseText));
					break;
...
function instantValidation(field) {
		...
		for (i = 0; i < ckeckboxs.length; i++) {
					if (ckeckboxs[i].checked==true) {
						ckeckboxs[i].parentNode.parentNode.querySelector('.form-field-valid').classList.add("visible");
					}
					ckeckboxs[i].parentNode.querySelector('.for-checkbox-mc').classList.remove("invalid");
		}
		...
		if (terms.checked==true) {
				terms.parentNode.parentNode.querySelector('.form-field-invalid').classList.remove("visible");
		}
	    ...
	    var invalid =
	      ...
	      (field.getAttribute("pattern") &&
	        ...
	        !new RegExp(field.getAttribute("pattern")).test(field.value));
					...
					var successmessage = field.parentNode.parentNode.querySelector('.form-field-valid');
					var errormessage = field.parentNode.parentNode.querySelector('.form-field-invalid');
			...
			if (salary.value != "") {
				...
				var successmessage = salary.parentNode.parentNode.querySelector('.form-field-valid');
				var errormessage = salary.parentNode.parentNode.querySelector('.form-field-invalid');
				...
				if(jQuery(frequency).find(':selected').prop('disabled')){
					...
					frequency.classList.remove("visible");
				}
			...
			/* Children at home */
				 ...
				 if(document.getElementById("choix_enfants").value == "oui") {
				 ...
				 /* spouse salary at home */
					...
					if(document.getElementById("etat_civil").value == "marie" || document.getElementById("etat_civil").value == "partenariat" ) {
						document.getElementById("spouse_position").classList.add("visible");
						document.getElementById("type_conjoint").setAttribute("required", "required");
					} else {
					...
					if(document.getElementById("type_conjoint").value != "foyer" && document.getElementById("type_conjoint").value != "" ) {
						document.getElementById("moyen_transport_conjoint_ligne").classList.add("visible");
						document.getElementById("moyen_transport_conjoint").setAttribute("required", "required");
						document.getElementById("frais_professionnels_conjoint_ligne").classList.add("visible");
						document.getElementById("frais_professionnels_conjoint").setAttribute("required", "required");

						document.getElementById("salary_spouse").classList.add("visible")
						document.getElementById("revenus_conjoint").setAttribute("required", "required");
 						document.getElementById("salaireX_conjoint").setAttribute("required", "required");

					} else {

						document.getElementById("moyen_transport_conjoint_ligne").classList.remove("visible");
						document.getElementById("frais_professionnels_conjoint_ligne").classList.remove("visible");
						...
						document.getElementById("frais_professionnels_conjoint").removeAttribute("required");
						document.getElementById("moyen_transport_conjoint").removeAttribute("required");
...
document.getElementById("moyen_transport").addEventListener('change', function(){
		if(this.value=="voiture strictement nécessaire"){
				...
				document.getElementById("nb_kilometres").setAttribute("required", "required");
		}
		else{;
...
document.getElementById("moyen_transport_conjoint").addEventListener('change', function(){

		if(this.value=="voiture strictement nécessaire"){
				document.getElementById("nb_kilometres_conjoint").classList.add("visible");
				document.getElementById("nb_kilometres_conjoint").setAttribute("required", "required");
		}
		else{;
				document.getElementById("nb_kilometres_conjoint").classList.remove("visible");
				document.getElementById("nb_kilometres_conjoint").value="";
				document.getElementById("nb_kilometres_conjoint").removeAttribute("required");
				switch(this.value){
						case "à pieds":
								document.getElementById('frais_mensuels_transport_conjoint').value="0";
								break;
						case "à vélo":
								document.getElementById('frais_mensuels_transport_conjoint').value="15";
								break;
						case "à moto":
								document.getElementById('frais_mensuels_transport_conjoint').value="55";
								break;
						case "transport en commun":
								document.getElementById('frais_mensuels_transport_conjoint').value="190";
								break;
						case "voiture sans stricte nécessite":
								document.getElementById('frais_mensuels_transport_conjoint').value="190";
				}
...
document.getElementById("nb_kilometres").addEventListener("focusout", function(){
	document.getElementById('frais_mensuels_transport').value=parseInt(this.value)*20;
});

document.getElementById("nb_kilometres_conjoint").addEventListener("focusout", function(){
	document.getElementById('frais_mensuels_transport_conjoint').value=parseInt(this.value)*20;
});
...
function validateForm() {
  ...
  for (i = 0; i < y.length; i++) {
    ...
    if ( y[i].value == "" && y[i].getAttribute("required") ) {
			...
			var errormessage = y[i].parentNode.parentNode.querySelector('.form-field-invalid');
			errormessage.classList.add("visible");
	  ...
	  v = x[currentTab].getElementsByTagName("select");
	    ...
	    if (v[i].value == "" && v[i].getAttribute("required") ) {
				...
				var errormessage = v[i].parentNode.parentNode.querySelector('.form-field-invalid');
				errormessage.classList.add("visible");
	  ...
	  valid = false;
		...
		if (terms.checked == false){
				terms.parentNode.parentNode.querySelector('.form-field-invalid').classList.add("visible");
				 valid = false;
		}
...
document.getElementById("cpa").addEventListener("change", function(){
	...
	document.getElementById("localite").value=cpa[document.getElementById("cpa").value];
...
jQuery(document).ready(function() {
		...
		*/
		...
		jQuery('#nextBtn').click(function() {
				...
				} else if( jQuery('.step-4').hasClass('active') && jQuery('#nextBtn').hasClass('mainformsteps') ) {
					if (valid) {
						dataLayer.push({
								event: 'enterCreditRequestFormStep',
								step: '4',
