                            ...
                            <form id="cr_f">
                                ...
                                <div class="tab">
                                    ...
                                    <div class="blocktitle title-center clearfix">
                                        ...
                                        <div class="ssl-block"><div class="ssl-img"><img src="https://www.multicredit.ch/wp/wp-content/uploads/secure-datas.svg" width="60px" height="28px"></div><div class="ssl-txt"><?php _e('Your data are transmitted to us in a secure mode and are hosted in Switzerland.','multicredit');?></div></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input aria-required="true" placeholder="<?php _e('First name','multicredit'); ?>" name="prenom" id="prenom" pattern="^([- \w\d\u00c0-\u024f]+)$"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><input aria-required="true" placeholder="<?php _e('Last name','multicredit'); ?>" name="nom" id="nom" pattern="^([- \w\d\u00c0-\u024f]+)$"
