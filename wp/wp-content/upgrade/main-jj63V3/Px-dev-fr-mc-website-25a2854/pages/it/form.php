...
<html lang="it">
<head>
<title>La vostra richiesta</title>
...
<div id="container">
	...
	<?php
		...
		?>
	<?php if (trim($output)==""):?>
			<p>La ringraziamo per la sua richiesta. I nostri consulenti la contatteranno rapidamente!</p>
	<?php endif;?>
	</div>
