...
<form id="cform" method="POST" action="<?php echo $_POST['lien'];?>">
	<div class="element e1">
		<p style="padding:0 15px;"><?php echo $factoring[$lang][0];?></p>
	</div>
	<div class="element e2">
		<p style="padding:0 15px;"><?php echo $factoring[$lang][1];?></p>
	</div>
	<div class="element e3">
		<p style="padding:0 15px;"><?php echo $factoring[$lang][2];?></p>
	</div>	
