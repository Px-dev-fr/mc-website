...
if ($_POST['soumission']==1){
	...
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, 'https://crm.cashflex.ch/curl/formulaires/prives/credit-new/etape_3.php');
...
<div id="container">
	...
	<?php
				...
				$curl = curl_init();
				curl_setopt($curl, CURLOPT_URL, 'https://crm.cashflex.ch/curl/formulaires/prives/credit-new/formulaire.php');
